  ...
  return (
    <section id="contato" className="relative overflow-hidden py-24 md:py-28 bg-white">
      ...
      <div className="container-page relative">
        <div className="mx-auto max-w-[860px] overflow-hidden rounded-[24px] bg-gradient-to-br from-[#5BC4D4] via-[#9B4DCA] to-[#7B2FA0] p-10 md:p-14 text-center text-white shadow-[var(--shadow-xl)]">
